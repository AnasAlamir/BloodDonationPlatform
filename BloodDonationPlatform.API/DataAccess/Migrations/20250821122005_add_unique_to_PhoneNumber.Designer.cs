...
namespace BloodDonationPlatform.API.DataAccess.Migrations
{
    ...
    [Migration("20250821122005_add_unique_to_PhoneNumber")]
    partial class add_unique_to_PhoneNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloodDonationPlatform.API.DataAccess.Models.Users.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Users", t =>
                        {
                            t.HasCheckConstraint("CK_User_Role_Valid", "Role IN ('Donor', 'Hospital', 'SystemAdmin')");
                        });
                });
            ...
            modelBuilder.Entity("BloodDonationPlatform.API.DataAccess.Models.Donor", b =>
                {
                    ...
                    b.HasOne("BloodDonationPlatform.API.DataAccess.Models.Users.User", "User")
                        .WithOne("Donor")
            ...
            modelBuilder.Entity("BloodDonationPlatform.API.DataAccess.Models.DonorDonationRequest", b =>
                {
                    ...
                    b.HasOne("BloodDonationPlatform.API.DataAccess.Models.Donor", "Donor")
                        .WithMany("DonorDonationRequests")
            ...
            modelBuilder.Entity("BloodDonationPlatform.API.DataAccess.Models.Donor", b =>
                {
                    b.Navigation("DonorDonationRequests");
                });
